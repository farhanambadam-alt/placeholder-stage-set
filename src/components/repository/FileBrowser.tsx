        ...
        <div className="divide-y divide-border/50">
          {files.map((file) => {
            ...
            return (
              <div
                key={file.sha}
                className={`file-browser-item group flex items-center gap-2 px-3 py-1.5 hover:bg-accent/10 active:bg-accent/20 transition-colors select-none ${isSelected ? 'bg-accent/20' : ''}`}
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm truncate text-foreground" title={file.name}>
                      {file.name}
                    </span>
                    {!isFolder && (
                      <span className="text-xs text-muted-foreground flex-shrink-0 ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-8 w-8 p-0 flex-shrink-0 md:opacity-0 md:group-hover:opacity-100 transition-opacity"
